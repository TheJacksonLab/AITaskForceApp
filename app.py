...
audio_bytes = st.audio_input("Record your 10-minute answer:")
...
if audio_bytes:
    ...
    with st.spinner("Transcribing audio..."):
        ...
        try:
            ...
            result = model.transcribe(
                temp_audio_path, 
                initial_prompt="Ideal gas law, PV=nRT, pressure, volume, temperature, moles, Kelvin, kinetic molecular theory, elastic collisions, intermolecular forces, universal gas constant."
            )
    ...
    # --- 3. EVALUATION: LLM Structured Output (using Ollama) ---
